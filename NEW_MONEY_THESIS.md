...
| other-hosting (colo / VPS / CDN, established) | Migrate (low-confidence until tier-2 confirms) | MAP (migration funding, no published dollar lane) | "A funded migration from your current hosting onto AWS." |
