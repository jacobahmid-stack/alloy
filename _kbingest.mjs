...
const DOCS = [
  { id: "aws-migration-tools", title: "AWS Prescriptive Guidance — Tools for Migrating to AWS", kind: "aws-doc" },
  { id: "aws-migration-hub-api", title: "AWS Migration Hub — User Guide", kind: "aws-doc" },
];
